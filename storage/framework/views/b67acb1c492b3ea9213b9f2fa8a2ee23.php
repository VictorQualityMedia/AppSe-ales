...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Recuérdame')); ?></span>
            </label>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Laravel\app_señal\resources\views/auth/login.blade.php ENDPATH**/ ?>